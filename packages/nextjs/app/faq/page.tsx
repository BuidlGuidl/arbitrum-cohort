...
export default function FaqPage() {
  return (
    <div className="container mx-auto">
      <div className="rounded-lg p-8 mb-8 w-full bg-[#d9d9d9] bg-[url('/bg-grid.svg')] bg-[center_top_-0.5rem]">
      ...
      {faqContent.map((item, index) => (
        <div key={item.title} className="mt-6 collapse collapse-plus bg-base-300">
          <input type="radio" name="faq-accordion" defaultChecked={index === 0 ? true : false} />
          <div className="collapse-title pr-8 pl-16 text-xl font-normal lg:text-3xl">{item.title}</div>
          <div className="collapse-content pr-8 pl-16 lg:text-xl/8">
